...
rmarkdown::render("vignettes/SymSim.Rmd", output_format = rmarkdown::github_document())
-->

```{r setup, include=FALSE, echo=FALSE}
knitr::opts_chunk$set(echo = TRUE, comment = "#", collapse = TRUE)
```
Here SymSim method will be demonstrated clearly and hope that this document can help you.
...
## Simulating datasets with cell trajectory using SymSim
...
In SymSim, we can set `nCells` and `nGenes` to specify the number of cells and genes.
