...
* install [Docker](https://www.docker.com/) first and download [simpipe Docker image](https://hub.docker.com/r/duohongrui/simpipe) from DockerHub. All manipulations in R can be done by a lightweight [simpipe2doker](https://github.com/duohongrui/simpipe2docker) package.
...
```{r eval=FALSE}
devtools::install_github("duhongrui/simpipe2docker")
```
